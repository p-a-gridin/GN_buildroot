...
EXTRA_TARGET_DIR = $(CURDIR)/../output/buildroot/target
...
ifeq ($(BR2_PACK_EXTRA_TARGET),y)
	@$$(call MESSAGE,"Generating filesystem image from extra target $$(ROOTFS_$(2)_FINAL_IMAGE_NAME)")
	mkdir -p $$(@D)
